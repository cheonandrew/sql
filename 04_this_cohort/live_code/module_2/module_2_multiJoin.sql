...
SELECT product_category_name, p.*, cp.product_id as productid_in_cust_purchases_table

FROM product_category as pc
INNER JOIN product as p -- this gives us product_name, product_size, product_qty_type
	ON p.product_category_id = pc.product_category_id
INNER JOIN customer_purchases as cp -- left join allows null values to be preserved
