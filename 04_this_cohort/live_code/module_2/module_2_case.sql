...
, -- comma tells SQL to make a new column starting from here
...
CASE WHEN vendor_name = "Annie's Pies" -- why did we use double quotes? It's because there's an apostrophe inside of here, it would've closed.
...
-- let's try adjusting prices for inflation
-- find items that cost less than a dollar, then multiply by 5
