...
FROM customer
--END QUERY
-- `SELECT *` also works. Called columns explicitly to ensure valid schema dependency
...
--QUERY 7
SELECT v.vendor_id, vba.market_date, v.vendor_name
FROM vendor AS v
...
--QUERY 8
SELECT vendor_id,
COUNT(vendor_id) AS count_vendor_booth_rent
